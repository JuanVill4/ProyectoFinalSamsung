...
while True:
    ...
    with canvas(device) as draw:
        ...
        # Verificar si los valores están dentro de los rangos deseados
        if hr < 0 or hr > 200 or sp < 0 or sp > 100:
            draw.text((0, 0), "Mala lectura", fill="red")
        else:
            # Mostrar la frecuencia cardíaca y la saturación de oxígeno
            draw.text((0, 0), f"Heart Rate: {hr} bpm")
